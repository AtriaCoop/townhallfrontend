          ...
          <div className={styles.settingsList}>
            ...
            <div className={styles.toggleRow}>
              <div className={styles.toggleInfo}>
                ...
                <span className={styles.toggleDescription}>
                  Other members can start a direct message conversation with
                  you.
                </span>
              </div>
              <button
            ...
            {activeModal === "changePassword" ? (
              <>
                ...
                <p className={styles.modalDescription}>
                  Enter your current password and choose a new one to update
                ...
                <div className={styles.modalActions}>
                  ...
                  <button
                    ...
                    disabled={
                      isProcessing ||
                      (activeModal === "deactivate" &&
                        verificationInput !== "deactivate") ||
                      (activeModal === "delete" &&
                        verificationInput !== "delete my account")
                    }
                  >
                    {isProcessing
                      ? "Processing..."
