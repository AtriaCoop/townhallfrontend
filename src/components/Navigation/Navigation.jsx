  ...
  return (
    <div className={styles.nav}>
      ...
      <div className={styles.logos}>
        ...
        <div className={`${styles.link} ${pathname === '/WorkingGroupsPage' ? styles.active : ''}`} onClick={() => router.push('/WorkingGroupsPage')}><Icon name="workingGroups" /><span className={styles.linkText}>Working Groups</span></div>
